...
define('ORIOLE_THEME_URL','https://wwwows.com/product/oriole-wordpress-theme/');
define('ORIOLE_SOCIAL_URL','https://www.facebook.com/wwwows/');
define('ORIOLE_DOCS_URL','https://wwwows.com/docs');

// Upgrade content
if ( ! function_exists( 'oriole_admin_theme_page_more_features' ) ) {
	function oriole_admin_theme_page_more_features() { ?>
<div class="wwwows-tp-s-box wwwows-tp-premium">
    <h4><?php esc_html_e( 'Oriole Premium', 'oriole' ); ?></h4>
    <p><?php esc_html_e( 'If You need the premium features for Your site, check the theme page on wwwows.com', 'oriole' ); ?></p>
    <a href="<?php echo esc_url(ORIOLE_THEME_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Get Oriole Premium', 'oriole' ); ?></a>
</div>
<?php
	}
}
...
// Title content
if ( ! function_exists( 'oriole_admin_theme_page_title' ) ) {
	function oriole_admin_theme_page_title() { ?>
<div class="wwwows-tp-title-area">
    <div class="wwwows-tp-title-content">
        <h1><?php esc_html_e( 'Oriole WordPress Theme', 'oriole' );?></h1>
        <p><?php esc_html_e( 'Thank You for using Oriole! Check all the theme features.', 'oriole' );?></p>
    </div>
    <h2><?php esc_html_e( 'Here You can see the theme features. At the theme page on wwwows.com You can find more details.', 'oriole' );?></h2>
</div>
<?php
	}
}    
 
// Oriole admin page content   
if ( ! function_exists( 'oriole_admin_theme_page' ) ) {
	function oriole_admin_theme_page() { ?>
<div id="wwwows-tp-page-body">
<div id="wwwows-tp-page-left">
	<?php oriole_admin_theme_page_title(); ?>
    <div class="wwwows-theme-features">
        <h3 class="wpp-heading"><span><?php esc_html_e( 'Free', 'oriole' ); ?></span><?php esc_html_e( ' Oriole features', 'oriole' ); ?></h3>
        
        <div class="clearflex"></div>
        
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(ORIOLE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Full Site Editor', 'oriole' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(ORIOLE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Fast Pageload', 'oriole' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(ORIOLE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'GPL License', 'oriole' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(ORIOLE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Partial Block Templates', 'oriole' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(ORIOLE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Translation Ready', 'oriole' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span><?php esc_html_e( 'Premium', 'oriole' ); ?></span><?php esc_html_e( ' Oriole features', 'oriole' ); ?></h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Additional Full Block Templates', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'WooCommerce Ready', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Google Fonts Options', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Wwwows Blocks', 'oriole' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span><?php esc_html_e( 'Additional blocks', 'oriole' ); ?></span><?php esc_html_e( ' for Oriole premium', 'oriole' ); ?></h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll animations', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Responsive control', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Back to top', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Image cursor', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Stylish scrollbar', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Accordion', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Countdown', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Icon', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Progress', 'oriole' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll text', 'oriole' ); ?></h4>
        </div>
...
<div id="wwwows-tp-page-right">
	<?php oriole_admin_theme_page_more_features(); ?>
	<div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows Documentation', 'oriole' ); ?></h4>
        <p><?php esc_html_e( 'If You`ve stuck, the documentation may help on Wwwows.com', 'oriole' ); ?></p>
        <a href="<?php echo esc_url(ORIOLE_DOCS_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Wwwows Documentation', 'oriole' ); ?></a>
    </div>
    <div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows on Facebook', 'oriole' ); ?></h4>
        <p><?php esc_html_e( 'If You want to get useful infos and discounts about Wwwows, follow Wwwows on Facebook.', 'oriole' ); ?></p>
        <a href="<?php echo esc_url(ORIOLE_SOCIAL_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Go to Facebook', 'oriole' ); ?></a>
    </div>
</div>
<?php
	}
